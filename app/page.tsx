  ...
  return (
    <div className="flex flex-col justify-center items-center h-[100dvh]">
      ...
      <div className="h-5/6 flex flex-col justify-center items-center gap-4 mt-30">
        ...
        <h1 className="text-6xl font-semibold"><span className="font-extralight">GET EARLY</span> ACCESS</h1>
        <p className="text-[var(--description)] w-lg text-center">Be the first to try our AI-powered job application filter that automatically screens candidates and finds your perfect hires!</p>

        <form action={addToWaitlist} className="flex gap-4 border px-5 py-3 rounded-2xl border-[var(--border)] bg-[var(--gray-background)]">
          <input type="email" name="email" className="outline-none w-xs" placeholder="your@email.com" required/>
